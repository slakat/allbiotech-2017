                            ...
                            <div class="col-sm-4">
                                <div class="footer-subscribe">
                                    ...
                                    <form novalidate="" target="_blank" class="" name="mc-embedded-subscribe-form" id="mc-embedded-subscribe-form" method="post"
                                        ...
                                        <input type="text" placeholder="<?php esc_attr_e('Ingresa tu email', 'onepress'); ?>" id="mce-EMAIL" class="subs_input" name="EMAIL" value="">
                                        <input type="submit" class="subs-button" value="<?php esc_attr_e('Suscríbete', 'onepress'); ?>" name="subscribe">
                                    </form>
                                </div>
                            </div>
                        <?php endif; ?>
...
<?php wp_footer(); ?>
<script src="http://themecube.net/eventr/js/owl.carousel.min.js"></script>
