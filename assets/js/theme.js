...
( function( $ ) {
        ...
        //LOAD MORE
        var $number = 4; 
        var $total =  jQuery('#list-speaker li').size();
         jQuery('#list-speaker li').hide();
    jQuery('#list-speaker li:lt(4)').show();
    
    jQuery('#loadmore').on("click", function () {
        $number = $number + 4;
        jQuery('#list-speaker li:lt('+$number+')').fadeIn();
        jQuery('#list-speaker li:lt('+$number+')').show();
        if ($total <= $number){
            jQuery('#loadmore').text('Lista completa');
        }
    });
